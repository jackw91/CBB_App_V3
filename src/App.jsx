  ...
  return (
    <div style={{ borderBottom: "1px solid #2a2824" }}>
      <div
        ...
        style={{
          padding: "14px 16px",
          background: done ? "rgba(232,217,197,0.05)" : "transparent",
      ...
      >
        ...
        <div className="cb-set-boxes" style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginTop: 12 }}>
          {setStates.map((checked, si) => (
            ...
            >
              {checked ? (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1c1a17" strokeWidth="3.5">
      ...
      {expanded && (
        <div className="cb-expand-panel" style={{ padding: "4px 16px 16px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap", alignItems: "flex-end" }}>
            <LogField label={`Weight (${unitLabel(unit)})`} value={log.w == null ? null : Math.round(toDisplay(log.w, unit, roundToLb, roundToKg) * 10) / 10} onChange={(v) => onLogChange(idx, { ...log, w: displayToLb(v, unit) })} step={unit === "kg" ? 1.25 : 2.5} />
      ...
      >
        ...
        <div style={{ overflowY: "auto", padding: "6px 0" }}>
          {rows.length === 0 ? (
            ...
            rows.map((r, i) => {
              const wDisplay = r.log.w != null ? toDisplay(r.log.w, unit, roundToLb, roundToKg) : null;
